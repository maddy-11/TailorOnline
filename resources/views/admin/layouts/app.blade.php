...
<body class="mod-bg-1 mod-nav-link ">
    ...
    <div class="page-wrapper">
        <div class="page-inner">
            @include('admin.includes.panels.sidebar')
            <!-- END Left Aside -->
            <div class="page-content-wrapper">
                ...
                <header class="page-header" role="banner">
                    ...
                    <div class="ml-auto d-flex">
                        ...
                        <!-- app user menu -->
                        <div>
                            <a href="#" data-toggle="dropdown" title=" {{$logged_in_user->email}}" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                ...
                                <!-- you can also add username next to the avatar with the codes below:
									...
									<i class="ni ni-chevron-down hidden-xs-down"></i> --></a>
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                        <span class="mr-2">
                                            <img src="{{asset('assets/img/demo/avatars/avatar-m.png')}}" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                        </span>
                                        <div class="info-card-text">
                                            <div class="fs-lg text-truncate text-truncate-lg"> {{$logged_in_user->name}}</div>
                                            <span class="text-truncate text-truncate-md opacity-80"> {{$logged_in_user->email}}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="dropdown-divider m-0"></div>
                                <a class="dropdown-item fw-500 pt-3 pb-3" href="{{ route('admin.logout') }}" onclick="event.preventDefault();
                ...
                <main id="js-page-content" role="main" class="page-content">
                    @include('admin.errors.messages')
                    @yield('content')
                </main>
                @include('admin.includes.panels.footer')
