...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-table"></i> companies:
        ...
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    <a href="{{route('admin.companies.create')}}" class="btn btn-primary btn-sm waves-effect waves-themed">Create New</a>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.default-example-modal-center', function(e) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    $('#overlay').fadeIn();
                    var modal_title = 'Enter New <small class="m-0 text-muted"> ' + title + '</small>';
