...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item">Fields Values</li>
        ...
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    <a href="{{route('admin.fieldvalues.create')}}" class="btn btn-primary btn-sm waves-effect waves-themed">Create New</a>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        $('#dt-basic-example').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "{!! route('admin.fieldvalues.list') !!}",
                type: 'get'
            },
            columns: [{
                    data: 'field_id'
