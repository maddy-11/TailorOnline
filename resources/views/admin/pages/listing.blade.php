                ...
                <div class="dropdown-menu dropdown-menu-animated w-auto h-auto">
                    ...
                    <div class="custom-scroll h-100">
                        <ul class="app-list">
                            ...
                            <li class="w-100">
                                <a href="#" class="btn btn-default mt-4 mb-2 pr-5 pl-5">
                                    Add more apps
                                </a>
                            </li>
                        </ul>
                                ...
                                <ul class="notification">
                                  ...
                                  "></span>
                                            ...
                                            <span class="d-flex flex-column flex-1 ml-1">
                                                <span class="name">Melissa Ayre
                                                    <span class="badge badge-primary fw-n position-absolute pos-top pos-right mt-1">INBOX</span></span>
                                ...
                                <ul class="notification">
                                        ...
                                        <div class="d-flex align-items-center show-child-on-hover">
                                            ...
                                            <div class="d-flex flex-column flex-1">
                                                ...
                                                <div class="fs-sm d-flex align-items-center mt-2">
                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="
                                      background-image: url('img/demo/avatars/avatar-a.png');
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center show-child-on-hover">
                                            ...
                                            <div class="d-flex flex-column flex-1">
                                                <span class="name">Dr John Cook
                                                    <span class="fw-300">sent a
                                                        <span class="text-danger">new signal</span></span></span>
                                            ...
                                            <div class="d-flex flex-column flex-1">
                                                ...
                                                <div class="fs-sm d-flex align-items-center mt-1">
                                                    <a href="#" class="mr-1 mt-1" title="Cell A-0012">
                                                        <span class="d-block img-share" style="
                                        ...
                                        <div class="d-flex align-items-center text-left mb-3">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <p>
                                                        <strong>4:30PM</strong> - Meeting with
                                                        Donnah V.
                                                    </p>
    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="subheader-icon fal fa-table"></i> DataTables:
                <span class="fw-300">Responsive</span>
    ...
    <footer class="page-footer" role="contentinfo">
        ...
        <div>
            <ul class="list-table m-0">
                ...
                <li class="pl-3 fs-xl">
                    <a href="https://wrapbootstrap.com/user/MyOrange" class="text-secondary" target="_blank"><i class="fal fa-question-circle" aria-hidden="true"></i></a>
                </li>
            </ul>
        </div>
    </footer>
