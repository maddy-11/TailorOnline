...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-table"></i> Suppliers:
...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Suppliers <span class="fw-300"><i>List</i></span>
                </h2>
                <div class="panel-toolbar">
                    <a href="{{route('admin.suppliers.create')}}" class="btn btn-primary btn-sm waves-effect waves-themed">Create New</a>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.default-example-modal-center', function(e) {
            ...
            $.ajax({
                url: case_id + '?current_status=' + current_status,
                type: "GET",
                dataType: 'html',
                processData: false,
                contentType: false,
                beforeSend: function() {
                    $('#overlay').fadeIn();
                    var modal_title = 'Update Supplier\'s <small class="m-0 text-muted"> Status</small>';
        ...
        $('#dt-basic-example').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "{!! route('admin.suppliers.list')!!}?status="+status,
                type: 'get'
            },
            columns: [{
                    data: 'bran_name'
