...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i> Supplier
        <small>
            Create New Supplier
        </small>
    </h1>
    ...
    <div class="col-xl-12">
        ...
        <div id="panel-4" class="panel">
            ...
            <div class="panel-container show">
                <form action="{{route('company.suppliers.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row ">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="bran_name" name="bran_name" class="form-control form-control-lg rounded-0" value="{{ old('bran_name') }}" placeholder="Brand Name">
                                    @error('bran_name')
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="full_business_name" name="full_business_name" class="form-control form-control-lg rounded-0" value="{{ old('full_business_name') }}" placeholder="Full Business Name">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="bank_name" name="bank_name" class="form-control form-control-lg rounded-0  @error('bank_name') is-invalid @enderror" value="{{ old('bank_name') }}" placeholder="Bank Name">
                                    @error('bank_name')
                                    <span class="invalid-feedback" role="alert"> {{ $message }}
                                    </span>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="bank_account_number" name="bank_account_number" class="form-control form-control-lg rounded-0  @error('bank_account_number') is-invalid @enderror" value="{{ old('bank_account_number') }}" placeholder="Bank Account Number">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="contact_person" name="contact_person" class="form-control form-control-lg rounded-0  @error('contact_person') is-invalid @enderror" value="{{ old('contact_person') }}" placeholder="Contact Person">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="contact_person_phone" name="contact_person_phone" class="form-control form-control-lg rounded-0  @error('contact_person_phone') is-invalid @enderror" value="{{ old('contact_person_phone') }}" placeholder="Contact Person Phone">
