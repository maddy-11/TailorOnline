...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Suppliers <span class="fw-300"><i>Lists</i></span>
                </h2>
                <div class="panel-toolbar">
                    <a href="{{route('company.suppliers.create')}}" class="btn btn-primary btn-sm waves-effect waves-themed">Create New</a>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.default-example-modal-center', function(e) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    $('#overlay').fadeIn();
                    var modal_title = 'Enter New <small class="m-0 text-muted"> Password</small>';
        ...
        $('#dt-basic-example').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "{!! route('company.suppliers.list') !!}?status=" + status,
                type: 'get'
            },
            columns: [{
                    data: 'bran_name'
