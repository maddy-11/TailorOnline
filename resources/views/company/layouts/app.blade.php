...
<body class="mod-bg-1 mod-nav-link ">
    ...
    <div class="page-wrapper">
        <div class="page-inner">
            @include('company.includes.panels.sidebar')
            <!-- END Left Aside -->
            <div class="page-content-wrapper">
                ...
                <header class="page-header" role="banner">
                    ...
                    <div class="ml-auto d-flex">
                        ...
                        <!-- app user menu -->
                        <div>
                            <a href="#" data-toggle="dropdown" title="{{$company_user->email}}" class="header-icon d-flex align-items-center justify-content-center ml-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                        <span class="mr-2">
                                            <img src="{{asset('assets/img/demo/avatars/avatar-m.png')}}" class="rounded-circle profile-image" alt="{{$company_user->first_name.' '.$company_user->last_name}}">
                                        </span>
                                        <div class="info-card-text">
                                            <div class="fs-lg text-truncate text-truncate-lg"></div>
                                            <span class="text-truncate text-truncate-md opacity-80">{{$company_user->email}}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="dropdown-divider m-0"></div>
                                <a class="dropdown-item fw-500 pt-3 pb-3" href="{{ route('company.signout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                    <span data-i18n="drpdwn.page-logout">{{ __('Logout') }}s</span>
                                    <span class="float-right fw-n">&commat;codexlantern</span>
                                </a>
                                <form id="logout-form" action="{{ route('company.signout') }}" method="POST" class="d-none">
                                    @csrf
                                </form>
                ...
                <main id="js-page-content" role="main" class="page-content">
                    @include('company.errors.messages')
                    @yield('content')
                </main>
                @include('company.includes.panels.footer')
