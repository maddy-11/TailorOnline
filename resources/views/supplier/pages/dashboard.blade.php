                                            ...
                                            <div class="d-flex flex-column flex-1">
                                                ...
                                                <div class="fs-sm d-flex align-items-center mt-2">
                                                    ...
                                                    <div data-hasmore="+3" class="rounded-circle profile-image-md mr-1">
                                                        <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url("{{asset('assets/demo/avatars/avatar-h.png')}}"); background-size: cover;"></span>
                                                    </div>
                                                </div>
